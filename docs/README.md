...
| `reports/source/` | Bản báo cáo Word đang được duy trì | `project_proposal.docx` |
...
Báo cáo Word hiện tại được lưu tại `reports/source/project_proposal.docx`. Khi chỉnh sửa bản trong repository, cần đồng bộ rõ ràng với bản làm việc trong Documents để tránh duy trì hai phiên bản khác nhau.
