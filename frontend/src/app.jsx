...
export default function app() {
    ...
    return <><Site_header {...auth} path={path} />{auth.error && <p className="global_error" role="alert">{auth.error}</p>}{page}{!auth_page && !['/bac_si/lich_hen','/bac_si/benh_nhan'].includes(path) && <Site_footer />}</>;
}
