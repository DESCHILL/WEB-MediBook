...
function profile_form({profile}) {
    ...
    const [saved,set_saved]=use_state(profile);
    ...
    async function save_profile(event) {
        ...
        try {
            ...
            set_data(result.profile);set_saved(result.profile);set_editing(false);set_notice('Đã lưu thông tin cá nhân.');
